...
console.log("Nur" * 8); //NaN yani not a number yani raqam emas (number malumot turi emas) qisqartirib NaN deyiladi nan ikkihil malumot turi bir biriga qo'shilganda chiqadi yani bu yerda string malumot turini number malumot ruriga ko'paytirish yozilgan bu holatda NaN chiqadi
...
//Null
// console.log(clientAge); //yani yo'q o'zgaruvchi chaqirilganda yani ishlatilganda  logda null malumot turi chiqadi chunki  clientGe degan o'zgaruvchi hech qayerda elon qilinmagan
...
console.log(theif.age); // objectni chaqirib nuqta qo'ilsa ichidagi qiymatlari chiqadi kerak bo'lsa har bir qiymatni alohida chaqirish mumkun objectni kerakli qiymatini unga berilgan propert yani keyi orqali alohida chaqirish mumkun
...
console.log(colors[0])//arrayda ichidagi qiymatlarni alohida chaqirish uchun shu >[] qavusdan foydalanish kerak yaniu []<shuni yozib ichiga 0dan boshlab raqamlar bilan arrayni ichidagi malumotlarni chaqirish mumkun bu yerda 0 chaqirildi shunda red chaqirilgan hissoblanadi chunki dasturlashda 0 ham raqam hissoblanadi 
