...
function form(modalTimerId) {
    ...
    function showThanksModal(message) {
        ...
        openModal(".modal", modalTimerId); //yani modal oyna yuqorida hide classi bilan yopilib bu ancha yuqorida boshida yozilgan openmodal functsiyasi bilan yana ochildi
