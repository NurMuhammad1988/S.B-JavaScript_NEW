...
// Spread operator (es9 dan boshlab shu nday uchta nuqta ... qilib yozish sintaksisi chiqgan chiqgan)
...
// logger(...calc); //yani ... nuqta spread operatori//yani bu holatda logger nomli function yaratilib parametriga x,y,z yozildi va function ichida x+y+z bo'lsin deb buyurildi yami argumentlar bir biriga qo'shilsin deyildi (javob 6) keyin logger functioni chaqirilganda argumentiga uchta nuqta bilan yani spread operatori bilan  massivdan iborat bo'lgan calc o'zgaruvchisi chaqirildi shunda spread operatori calcni ichidagi massivni va qiymati 1 2 3 ni loggerni argumentiga qo'ydi yani copiy qildi va javob yana 6
