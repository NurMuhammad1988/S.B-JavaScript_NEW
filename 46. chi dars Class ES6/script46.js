...
//     }
// }
// const bmw = new Car("BMW", "Black", 200); //(OOP)!!! //yani bu holatda new car qilib car class konstrucktordan object nusxalandi
...
//     //jsda classlar doim katta hariflar bilan yoziladi shunda js Carni class component ekanligini tushunadi
//     constructor(name, color, speed) {
//         //constructor//Konstruktor  bu classning objekt namunasini yaratadigan va ishga tushiradigan maxsus funktsiya JavaScriptda CLASS kalit so'zi yordamida objekt yaratilganda konstruktor chaqiriladi
//         this.name = name;
//         this.color = color;
//         this.speed = speed;
...
// class Spark extends Car {//extends (yani uzatma) Car ona classdan vorislanadigan alohida objectga nimadur qo'shimcha qo'shish kerak bo'lganda chaqiriladigan kalit so'z hissoblanadi yani bu holatda car ona classida yo'q lekin spark classiga qo'shilishi kerak bo'lgan qiymatlar isairbag va extratire qiymatlarini qo'shish uchun chaqirildi
...
//     constructor(name, color, isAirbag, extraTire) {//Car ona classida yoq qiymatlar isairbag va extratire
...
//class  va konstruktor funktsiyalari o'rtasidagi asosiy farq shundaki, sinflar meros qilib olinishi mumkin, konstruktor funktsiyalari esa mumkin emas?????????????????????????????????????????????????
