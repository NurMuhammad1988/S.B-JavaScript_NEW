...
const obj = {
    ...
    sum: function () {
        ...
        const logger = () => {
            ...
            console.log(this); // endi console.log(this.x) console.log(this.y)console.log(this.) qilibham alohidaalohid achaqirish mumkun
        };
        logger(); //bu holatda sum: qiymatiga tegishli oddiy funksiyani ichida logger strelkali yani const callback funksiyada contex this chaqirildi//yani callback funksiyada o'zini contexsi bo'lmaydi//ODDIY funksiya bilan const>>>(=>) callback funskiyani farqi calback funksiyada o'zini shaxsiy contexsi bo'lmaydi shu sabab contex thisni o'ziga contex qilib olib thisni objectni o'ziga teng qilib oladi
    },
...
// const btn = document.querySelector("button"); //lekin bu holatda callback funksiyani hech qanday contexti bo'lmagani sabab hato beradi chunki callback strelkali funsiyani contextida window objecti yoq shusabab pastki btn1 o'zgaruvchida (e) target bilan qilingani to'g'ri hissoblanadi
// btn.addEventListener("click", () => {
