...
// const user = "Nur";
// console.log(user.length); //length propert hissoblanadi yani string malumot turini bittagina apropertiysi bor buham bo'lsa lenght hissoblanadi yani logda funksiya bilan birga chaqiriladi va funksiyda yozilgan string malumot turini nechta ekanligini sanaydi yani uzunligini nechta element borligini  sanaydi
// const arr = [1, 2, 3, 4];
...
// const user = "Nur";
// const arr = [1, 2, 3, 4];
// console.log(user[2]);//yani bu joyda r chiqadi yani nurdagi r ni yani 3 chi elementni oldi chunki noldan boshlanadi stringni ichidagi har qanday harifni shunday olish mumkun
...
// const user = "nur";
// console.log(user.toUpperCase()); //toUpperCase() bu metod user o'zgaruvchidagi string malumot turi bo'lgan nurni hamma harifini katta harif qilib beradi metodlar huddi funksiya kabi chaqirilishi kerak manashunday>>>()
...
// console.log(user);//bu asosiy chaqirilgani bunda hech narsa o'zgarmaydi chunki toUpperCase() metodi yangi qiymatni o'zgartiradi asosiy qiymatni emas
// //////////////////////////////////////////////////////////////////////
...
// const greating = "Hello world";
// console.log(greating.slice(6, 11)); //slice() yani kesib olish metodi o'zgaruvchi ichidagi string malumot turini indexsiga qarab kerakli joyini kesib olish yani indexsiga yani raqamiga qarab 6 chi harf bilan 11 chi harf orasidagi hariflarni kesib oldi yani  world ni  agar 0 bilan 5 belgilansa shularni orasida bo'lgan hello ni qirqib oladi
