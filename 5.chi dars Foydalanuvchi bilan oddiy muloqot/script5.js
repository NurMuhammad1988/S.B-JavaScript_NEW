...
// console.log( typeof age + 10);//yani typeof buyrug'i bilan ageni qanday malumot turiga mansub ekanligini bildik yani string promptdagi default holatdaham user yozishi mumkun bo'lgan holatdaham malumot turi string hissoblanadi
console.log( age1 + 10);//yani string malumot turi bilan number malumot turi qo'shiladi yani "18" + 10 = 1810

const age2 = +prompt("How old are you", "18")// + belgisi yordamida promptda kelayotgan string malumot turini number malumot turiga o'zgartirish mumkun ekan va +prompt yani promp pilus belgisi bilan yozilganda string malumot turi bilan number malumot turini realni qo'shib beradi yani logda  "18" + 10 = 28
...
console.log( age2 + 10);//+prompt yani    promp pilus belgisi bilan yozilganda string malumot turi bilan number malumot turini realni qo'shib beradi yani logda  "18" + 10 = 28
...
favoriteColor[0] = prompt("What's your favorite color #1", ""); // agar massivni 1 chi elementdan boshlab chaqirilsa malumotlar buzulib ketadi yani 0 chielement empty yani bo'sh bo'lib qoladi bu malumotlar ketma ketligini buzib tashlaydi //bo'sh qo'shtirnoq qoldirlishini sababi user aslida shu qo'shtirnoqni ichiga yozadi yani user yozgan malumot shu qo'shtirnoqni ichiga tushadi
